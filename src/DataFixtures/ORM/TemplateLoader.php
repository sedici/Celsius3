...
namespace Celsius3\DataFixtures\ORM;
...
class TemplateLoader extends AbstractFixture implements FixtureInterface, ContainerAwareInterface, OrderedFixtureInterface
{
    ...
    private $notification_templates = [
        NotificationManager::CAUSE__NEW_MESSAGE => [
            'class' => NotificationTemplate::class,
            'text' => 'You have a new message from {{ user }}.',
        ],
        NotificationManager::CAUSE__NEW_USER => [
            'class' => NotificationTemplate::class,
    ...
    private $mail_templates = [
        EmailTemplateController::MAIL__ORDER_PRINTED => [
        ...
        EmailTemplateController::MAIL__ORDER_CANCEL => [
        ...
        EmailTemplateController::MAIL__ORDER_PRINTED_RECONFIRM => [
        ...
        EmailTemplateController::MAIL__ORDER_DOWNLOAD => [
        ...
        EmailTemplateController::MAIL__USER_WELCOME => [
        ...
        EmailTemplateController::MAIL__USER_LOST => [
        ...
        EmailTemplateController::MAIL__USER_WELCOME_PROVISION => [
