...
class AdminJournalRestController extends BaseInstanceDependentRestController
{
    ...
    public function createJournal(Request $request)
    {
        ...
        $journal->setInstance($em->getRepository('Celsius3CoreBundle:Instance')->find($request->request->get('instance')));
        ...
        $material = $em->getRepository('Celsius3CoreBundle:JournalType')->find($request->request->get('material_type_id'));
