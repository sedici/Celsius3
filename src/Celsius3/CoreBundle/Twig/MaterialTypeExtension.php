...
class MaterialTypeExtension extends \Twig_Extension
{
    ...
    private $materials = array(
            'BookType' => array('template' => '_book.html.twig',
                    'class' => 'book',),
            'CongressType' => array('template' => '_congress.html.twig',
                    'class' => 'congress',),
            'JournalType' => array('template' => '_journal.html.twig',
                    'class' => 'journal',),
            'PatentType' => array('template' => '_patent.html.twig',
                    'class' => 'patent',),
            'ThesisType' => array('template' => '_thesis.html.twig',
                    'class' => 'thesis',),);
    ...
    {
        return array(
                'render_material' => new \Twig_Function_Method($this,
                        'renderMaterial'),
                'get_material_type' => new \Twig_Function_Method($this,
                        'getMaterialType'),);
    }
    ...
    public function renderMaterial(MaterialType $material)
    {
        return $this->environment
                ->render(
                        'Celsius3CoreBundle:MaterialType:'
                                . $this
                                        ->materials[$this
                                                ->getClassName($material)]['template'],
                        array('materialData' => $material,));
    }
